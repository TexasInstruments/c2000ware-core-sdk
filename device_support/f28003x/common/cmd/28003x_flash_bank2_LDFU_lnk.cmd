MEMORY
{
   ...
   //
   BANK2_SEC1       : origin = 0xA1000,  length = 0x000017
   /* BANK 0 */
  ...
  /* BANK 2 */
   ...
   FLASH_BANK2_SEC1  : origin = 0x0A1017, length = 0x000FE9
...
SECTIONS
{
   ...
   .text            : >> FLASH_BANK2_SEC0 | FLASH_BANK2_SEC1 ,   ALIGN(8)
   .cinit           : > FLASH_BANK2_SEC1,  ALIGN(8)
   ...
   .init_array      : > FLASH_BANK2_SEC0,  ALIGN(8)
   .bss             : > RAMLS5
   .bss:output      : > RAMLS3
   .bss:cio         : > RAMLS0
   .data            : > RAMLS5
...
#else
   .pinit           : > FLASH_BANK2_SEC0,  ALIGN(8)
   .ebss            : > RAMLS5
   .esysmem         : > RAMLS5
   .cio             : > RAMLS0
