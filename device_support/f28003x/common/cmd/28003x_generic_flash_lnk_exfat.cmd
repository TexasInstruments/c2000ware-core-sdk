MEMORY
{
   ...
   RAMLS1_4           : origin = 0x00008800, length = 0x00002000
   ...
   FLASH_BANK0_SEC4_15  : origin = 0x084000, length = 0x00C000
...
SECTIONS
{
   ...
   .text            : >> FLASH_BANK0_SEC2 | FLASH_BANK0_SEC3 | FLASH_BANK0_SEC4_15,   ALIGN(8)
   ...
   .data            : > RAMLS6
   .sysmem          : > RAMLS1_4
   .const           : > FLASH_BANK0_SEC4_15,  ALIGN(8)
#else
   .pinit           : > FLASH_BANK0_SEC1,  ALIGN(8)
   .ebss            : > RAMLS5
   .esysmem         : > RAMLS5
   .cio             : > RAMLS0
   .econst          : > FLASH_BANK0_SEC4_15,  ALIGN(8)
#endif
