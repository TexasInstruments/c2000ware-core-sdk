...
{
   codestart        : > BEGIN
   .text            : >> FLASH_BANK0, ALIGN(32)
   .cinit           : > FLASH_BANK0, ALIGN(32)
   .switch          : > FLASH_BANK0, ALIGN(32)
   ...
   .bss             : > RAMLS5
   .bss:output      : > RAMLS3
   .init_array      : > FLASH_BANK0, ALIGN(32)
   .const           : > FLASH_BANK0, ALIGN(32)
   .data            : > RAMLS5  | RAMLS6
   .sysmem          : > RAMLS4
#else
   .pinit           : > FLASH_BANK0, ALIGN(32)
   .ebss            : >> RAMLS5 | RAMLS6
   .econst          : > FLASH_BANK0, ALIGN(32)
   .esysmem         : > RAMLS5
#endif
   ...
   DataBufferSection : > RAMGS0, ALIGN(32)

#if defined(__TI_EABI__)
   GROUP
     {
       .TI.ramfunc :
	  { -l FAPI_F28P551x_EABI_v6.00.00.lib}
		      } LOAD = FLASH_BANK0,
                        RUN = RAMGS0,
