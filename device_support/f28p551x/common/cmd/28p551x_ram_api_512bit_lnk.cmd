...
SECTIONS
{
   ...
   .TI.ramfunc      : > RAMLS2, ALIGN(32)

   fapi             : > RAMLS8
   {
       --library=FAPI_F28P551x_EABI_v6.00.00.lib
   ...
   .cinit           : > RAMM0, ALIGN(32)
   .switch          : > RAMM0, ALIGN(32)
   ...
   .bss             : > RAMLS5
   .bss:output      : > RAMLS3
   .init_array      : > RAMM0, ALIGN(32)
   .const           : > RAMLS5 | RAMLS6, ALIGN(32)
   .data            : > RAMLS5
   .sysmem          : > RAMLS4
#else
   .pinit           : > RAMM0
   ...
   ramgs1 : > RAMGS1
    ...
    DataBufferSection : > RAMLS3, ALIGN(32)
/*
#if defined(__TI_EABI__)
   GROUP
     {
