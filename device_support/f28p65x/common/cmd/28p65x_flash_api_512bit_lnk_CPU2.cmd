MEMORY
{
   ...
   FLASH_BANK1     : origin = 0x0A0002, length = 0x1FFFE  // Can be mapped to either CPU1 or CPU2. User should comment/uncomment based on core selection
...
{
   codestart        : > BEGIN
   .text            : >> FLASH_BANK1, ALIGN(32)
   .cinit           : > FLASH_BANK1, ALIGN(32)
   .switch          : > FLASH_BANK1, ALIGN(32)
   ...
   DataBufferSection : > RAMGS3, ALIGN(32)
