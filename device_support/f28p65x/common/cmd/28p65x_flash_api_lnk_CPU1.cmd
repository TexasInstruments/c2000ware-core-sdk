...
{
   codestart        : > BEGIN
   .text            : >> FLASH_BANK2, ALIGN(8)
   .cinit           : > FLASH_BANK2, ALIGN(8)
   .switch          : > FLASH_BANK2, ALIGN(8)
   ...
   .bss             : > RAMLS5
   .bss:output      : > RAMLS3
   .init_array      : > FLASH_BANK2, ALIGN(8)
   .const           : > FLASH_BANK2, ALIGN(8)
   .data            : > RAMLS5
   .sysmem          : > RAMLS4
#else
   .pinit           : > FLASH_BANK2, ALIGN(8)
   .ebss            : >> RAMLS5 | RAMLS6
   .econst          : > FLASH_BANK2, ALIGN(8)
   .esysmem         : > RAMLS5
#endif
