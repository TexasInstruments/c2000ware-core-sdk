let SYSCTLRegisters = [
	...
	{ name: "LSEN", description: "Lockstep enable configuration", offset: "0x82",
		bits: [
	...
	{ name: "LCM_ERR_FLG", description: "Status register indicating lockstep compare", offset: "0x18",
		bits: [
			...
			{ name: "CLR_CPU", description: "CPU1 Lockstep Miscompare flag clear", size: "1", shift: "1", mask: "0x2" },
			{ name: "SET_CPU", description: "CPU1 Lockstep Miscompare flag clear set", size: "1", shift: "1", mask: "0x2" },
