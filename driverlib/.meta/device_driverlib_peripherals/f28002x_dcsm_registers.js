let DCSMRegisters = [
	...
	{ name: "Z2OTP_BOOTPIN_CONFIG", description: "Boot Pin Configuration", offset: "0xC",
		bits: [
		]
	},
	{ name: "Z2OTP_GPREG2", description: "Zone-2 General Purpose Register-2 content", offset: "0xE",
		bits: [
		]
	},
	...
	{ name: "Z2OTP_BOOTDEF_LOW", description: "Boot definition (low 32bit)", offset: "0x1C",
		bits: [
		]
	},
	{ name: "Z2OTP_BOOTDEF_HIGH", description: "Boot definition (high 32bit)", offset: "0x1E",
		bits: [
		]
	},
	...
	{ name: "Z2_BOOTDEF_HIGH", description: "Boot definition (high 32bit)", offset: "0x4",
		bits: [
		]
	},
	...
	{ name: "Z2_BOOTPIN_CONFIG", description: "Boot Pin Configuration", offset: "0x8",
		bits: [
		]
	},
	{ name: "Z2_GPREG2", description: "Zone2 General Purpose Register-2", offset: "0xA",
		bits: [
		]
	},
	{ name: "Z2_BOOTDEF_LOW", description: "Boot definition (low 32bit)", offset: "0xC",
		bits: [
		]
	},
