let ERADRegisters = [
	...
	{ name: "CTM_INPUT_SEL", description: "Counter Input Select Register", offset: "0x8",
		bits: [
			...
			{ name: "2_STO_INP_SEL", description: "Counter Stop Input Select", size: "7", shift: "0", mask: "0x7F" },
			{ name: "2_RST_INP_SEL", description: "Counter Reset input Select", size: "7", shift: "8", mask: "0x7F00" },
		]
	},
