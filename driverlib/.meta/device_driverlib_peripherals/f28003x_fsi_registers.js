let FSIRegisters = [
	{ name: "TX_MASTER_CTRL", description: "Transmit main control register", offset: "0x0",
		bits: [
	...
	{ name: "TX_DLYLINE_CTRL", description: "Transmit delay Line control register", offset: "0x24",
		bits: [
	...
	{ name: "RX_MASTER_CTRL", description: "Receive main control register", offset: "0x0",
		bits: [
	...
	{ name: "RX_FRAME_TAG_CMP", description: "Receive frame tag compare register", offset: "0x28",
		bits: [
	...
	{ name: "RX_PING_TAG_CMP", description: "Receive ping tag compare register", offset: "0x29",
		bits: [
	...
	{ name: "RX_TRIG_CTRL_0", description: "Receive Trigger Control register 0", offset: "0x2C",
		bits: [
	...
	{ name: "RX_TRIG_WIDTH_0", description: "Receive Trigger Wdith register 0", offset: "0x2E",
		bits: [
	...
	{ name: "RX_TRIG_CTRL_1", description: "Receive Trigger Control register 1", offset: "0x32",
		bits: [
			{ name: "TRIG_EN", description: "Enable Trigger Function", size: "1", shift: "0", mask: "0x1" },
			{ name: "TRIG_SEL", description: "Input Select for Trigger", size: "4", shift: "1", mask: "0x1E" },
			{ name: "RX_TRIG_DLY", description: "Delay for Trigger generation", size: "24", shift: "8", mask: "0xFFFFFF00" },
	...
	{ name: "RX_TRIG_CTRL_2", description: "Receive Trigger Control register 2", offset: "0x34",
		bits: [
			{ name: "TRIG_EN", description: "Enable Trigger Function", size: "1", shift: "0", mask: "0x1" },
			{ name: "TRIG_SEL", description: "Input Select for Trigger", size: "4", shift: "1", mask: "0x1E" },
			{ name: "RX_TRIG_DLY", description: "Delay for Trigger generation", size: "24", shift: "8", mask: "0xFFFFFF00" },
	...
	{ name: "RX_TRIG_CTRL_3", description: "Receive Trigger Control register 3", offset: "0x36",
		bits: [
			{ name: "TRIG_EN", description: "Enable Trigger Function", size: "1", shift: "0", mask: "0x1" },
			{ name: "TRIG_SEL", description: "Input Select for Trigger", size: "4", shift: "1", mask: "0x1E" },
			{ name: "RX_TRIG_DLY", description: "Delay for Trigger generation", size: "24", shift: "8", mask: "0xFFFFFF00" },
	...
	{ name: "RX_UDATA_FILTER", description: "Receive User Data Filter Control register", offset: "0x3A",
		bits: [
