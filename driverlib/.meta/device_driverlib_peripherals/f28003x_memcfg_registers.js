let MEMCFGRegisters = [
	...
	{ name: "MSGXRAMTEST_LOCK", description: "Lock register for MSGx RAM TEST Register", offset: "0x76",
		bits: [
	...
	{ name: "NMAVFLG", description: "Non-Master Access Violation Flag", offset: "0x0",
		bits: [
	...
	{ name: "NMAVSET", description: "Non-Master Access Violation Flag Set", offset: "0x2",
		bits: [
	...
	{ name: "NMAVCLR", description: "Non-Master Access Violation Flag", offset: "0x4",
		bits: [
	...
	{ name: "NMAVINTEN", description: "Non-Master Access Violation", offset: "0x6",
		bits: [
	...
	{ name: "NMCPURDAVADDR", description: "Non-Master CPU Read Access Violation", offset: "0x8",
		bits: [
		]
	},
	{ name: "NMCPUWRAVADDR", description: "Non-Master CPU Write Access", offset: "0xA",
		bits: [
		]
	},
	{ name: "NMCPUFAVADDR", description: "Non-Master CPU Fetch Access", offset: "0xC",
		bits: [
		]
	},
	{ name: "NMDMAWRAVADDR", description: "Non-Master DMA Write Access", offset: "0xE",
		bits: [
		]
	},
	{ name: "NMCLA1RDAVADDR", description: "Non-Master CLA1 Read Access", offset: "0x10",
		bits: [
		]
	},
	{ name: "NMCLA1WRAVADDR", description: "Non-Master CLA1 Write Access", offset: "0x12",
		bits: [
		]
	},
	{ name: "NMCLA1FAVADDR", description: "Non-Master CLA1 Fetch Access", offset: "0x14",
		bits: [
		]
	},
	{ name: "NMDMARDAVADDR", description: "Non-Master DMA Read Access Violation", offset: "0x1C",
		bits: [
		]
	},
	{ name: "MAVFLG", description: "Master Access Violation Flag", offset: "0x20",
		bits: [
	...
	{ name: "MAVSET", description: "Master Access Violation Flag Set", offset: "0x22",
		bits: [
	...
	{ name: "MAVCLR", description: "Master Access Violation Flag Clear", offset: "0x24",
		bits: [
	...
	{ name: "MAVINTEN", description: "Master Access Violation Interrupt", offset: "0x26",
		bits: [
	...
	{ name: "MCPUFAVADDR", description: "Master CPU Fetch Access Violation", offset: "0x28",
		bits: [
		]
	},
	{ name: "MCPUWRAVADDR", description: "Master CPU Write Access Violation", offset: "0x2A",
		bits: [
		]
	},
	{ name: "MDMAWRAVADDR", description: "Master  DMA Write Access Violation", offset: "0x2C",
		bits: [
		]
	},
	{ name: "MHICWRAVADDR(i)", description: "(0 <= i < 2) Master  HIC Write", offset: "(0x2EU + ((i) * 0x2U))",
		bits: [
		]
	},
	{ name: "NMHICRDAVADDR", description: "Non-Master HIC Read Access Violation", offset: "0x3C",
		bits: [
		]
	},
	{ name: "NMHICWRAVADDR", description: "Non-Master HIC Write Access", offset: "0x3E",
		bits: [
		]
	},
	...
	{ name: "CHICREADDR", description: "Correctable HIC Read Error Address", offset: "0x3A",
		bits: [
		]
	},
