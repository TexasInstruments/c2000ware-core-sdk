let FLASHRegisters = [
	...
	{ name: "PUMPREQUEST", description: "Flash programming semaphore PUMP request register", offset: "0x0",
		bits: [
			{ name: "PUMP_OWNERSHIP", description: "Flash Pump Request Semaphore between", size: "2", shift: "0", mask: "0x3" },
			{ name: "KEY", description: "Key Qualifier for writes to this", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
];
module.exports = {
