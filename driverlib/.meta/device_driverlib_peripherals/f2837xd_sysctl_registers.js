let SYSCTLRegisters = [
	...
	{ name: "DC19", description: "Device Capability: CPU2 Lx SRAM Customization", offset: "0x36",
		bits: [
	...
	{ name: "RSTSTAT", description: "Reset Status register for secondary C28x CPUs", offset: "0x124",
		bits: [
			...
			{ name: "CPU2NMIWDRST", description: "Indicates whether a CPU2.NMIWD reset was issued", size: "1", shift: "1", mask: "0x2" },
			{ name: "CPU2HWBISTRST0", description: "Indicates whether a HWBIST reset was issued to", size: "1", shift: "2", mask: "0x4" },
			{ name: "CPU2HWBISTRST1", description: "Indicates whether a HWBIST reset was issued to", size: "1", shift: "3", mask: "0x8" },
		]
	},
