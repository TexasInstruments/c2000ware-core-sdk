let PMBUSRegisters = [
	{ name: "PMBMC", description: "PMBUS Master Mode Control Register", offset: "0x0",
		bits: [
	...
	{ name: "PMBSC", description: "PMBUS Slave Mode Configuration Register", offset: "0xC",
		bits: [
			{ name: "SLAVE_ADDR", description: "Configures the current device address of the", size: "7", shift: "0", mask: "0x7F" },
	...
	{ name: "PMBHSA", description: "PMBUS Hold Slave Address Register", offset: "0xE",
		bits: [
	...
	{ name: "PMBTIMCLK", description: "PMBUS Clock Timing Register", offset: "0x14",
		bits: [
			{ name: "CLK_HIGH_LIMIT", description: "Determines the PMBUS master clock high", size: "8", shift: "0", mask: "0xFF" },
			{ name: "CLK_FREQ", description: "Determines the PMBUS master clock", size: "8", shift: "16", mask: "0xFF0000" },
		]
	},
	{ name: "PMBTIMSTSETUP", description: "PMBUS Start Setup Time Register", offset: "0x16",
		bits: [
			{ name: "TSU_STA", description: "Setup time, rise edge of PMBUS master clock to", size: "8", shift: "0", mask: "0xFF" },
		]
	},
