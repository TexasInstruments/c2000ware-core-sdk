...
let EQEP_Source = [
	...
	{ name: "EQEP_SOURCE_ZERO", displayName: "signal tied to zero" },
	{ name: "EQEP_SOURCE_MCPWMXBAR1", displayName: "signal comes from MCPWMXBAR1" },
	{ name: "EQEP_SOURCE_MCPWMXBAR2", displayName: "signal comes from MCPWMXBAR2" },
	{ name: "EQEP_SOURCE_MCPWMXBAR3", displayName: "signal comes from MCPWMXBAR3" },
	{ name: "EQEP_SOURCE_MCPWMXBAR4", displayName: "signal comes from MCPWMXBAR4" },
	{ name: "EQEP_SOURCE_MCPWMXBAR5", displayName: "signal comes from MCPWMXBAR5" },
	{ name: "EQEP_SOURCE_MCPWMXBAR6", displayName: "signal comes from MCPWMXBAR6" },
	{ name: "EQEP_SOURCE_MCPWMXBAR7", displayName: "signal comes from MCPWMXBAR7" },
	{ name: "EQEP_SOURCE_MCPWMXBAR8", displayName: "signal comes from MCPWMXBAR8" },
]
