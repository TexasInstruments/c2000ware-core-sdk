let FLASHRegisters = [
	...
	{ name: "FLPROT", description: "Flash program/erase protect register", offset: "0x2",
		bits: [
			{ name: "FLWEPROT", description: "Flash write/erase protect bit.", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "FRD_INTF_CTRL", description: "Flash Read Interface Control Register", offset: "0x6",
		bits: [
	...
	{ name: "FECC_CTRL", description: "ECC Control", offset: "0x2",
		bits: [
