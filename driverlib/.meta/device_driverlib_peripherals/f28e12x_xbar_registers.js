let XBARRegisters = [
	...
	{ name: "CLR1", description: "X-Bar Input Flag Clear Register 1", offset: "0xA",
		bits: [
	...
	{ name: "CLR2", description: "X-Bar Input Flag Clear Register 2", offset: "0xC",
		bits: [
	...
	{ name: "CLR3", description: "X-Bar Input Flag Clear Register 3", offset: "0xE",
		bits: [
	...
	{ name: "CLR4", description: "X-Bar Input Flag Clear Register 4", offset: "0x10",
		bits: [
			{ name: "ERRORSTS_ERROR", description: "Input Flag clear for ERRORSTS_ERROR Signal", size: "1", shift: "28", mask: "0x10000000" },
		]
	},
	{ name: "CLR5", description: "X-Bar Input Flag Clear Register 5", offset: "0x12",
		bits: [
