...
let PGA_PMUXInput = [
	{ name: "PGA_PMUX_POS", displayName: "PGA_POS as non-inverting input" },
	{ name: "PGA_PMUX_VSSA", displayName: "VSSA as non-inverting input" },
]
let PGA_NMUXInput = [
	{ name: "PGA_NMUX_RTOP", displayName: "RTOP as inverting input" },
	{ name: "PGA_NMUX_RTAP", displayName: "RTAP as inverting input" },
	{ name: "PGA_NMUX_NEG", displayName: "PGA_NEG as inverting input" },
]
let PGA_MMUXInput = [
