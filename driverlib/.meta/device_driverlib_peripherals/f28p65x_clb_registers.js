let CLBRegisters = [
	...
	{ name: "MISC_ACCESS_CTRL", description: "Miscellaneous Access and enable control", offset: "0x50",
		bits: [
	...
	{ name: "IN_MUX_SEL_0", description: "Input selection to decide between Signals and GP", offset: "0x8",
		bits: [
	...
	{ name: "HLC_INSTR_READ_PTR", description: "HLC instruction read pointer", offset: "0x24",
		bits: [
			{ name: "READ_PTR", description: "HLC instruction read pointer", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "HLC_INSTR_VALUE", description: "HLC instruction read value", offset: "0x26",
		bits: [
			{ name: "INSTR", description: "HLC instruction value", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "DBG_OUT_2", description: "Visibility for CLB inputs and final  asynchronous", offset: "0x2E",
		bits: [
	...
	{ name: "PUSH(i)", description: "(0 <= i < 4) CLB_PUSH FIFO Registers (from HLC)", offset: "(0x0U + ((i) * 0x2U))",
		bits: [
		]
	},
	{ name: "PULL(i)", description: "(0 <= i < 4) CLB_PULL FIFO Registers (TO HLC)", offset: "(0x40U + ((i) * 0x2U))",
		bits: [
		]
	},
];
