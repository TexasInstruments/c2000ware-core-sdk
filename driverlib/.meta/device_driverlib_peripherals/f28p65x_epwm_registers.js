let EPWMRegisters = [
	...
	{ name: "XLINK2", description: "EPWMx Link 2 Register", offset: "0x3A",
		bits: [
	...
	{ name: "XLOADCTL", description: "XCMP Mode Load Control Register", offset: "0x8",
		bits: [
			...
			{ name: "SHDWLEVEL", description: "Shadow Register Level Allocation", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "XLINKXLOAD", description: "Link register across PWM modules", offset: "0xE",
		bits: [
	...
	{ name: "XREGSHDW1STS", description: "Shadow Buffer 1 Update Status Register", offset: "0x10",
		bits: [
			...
			{ name: "XMIN_SHDW1FULL", description: "XMINMAX_SHDW1 register full Status flag:", size: "1", shift: "14", mask: "0x4000" },
		]
	},
	{ name: "XREGSHDW2STS", description: "Shadow Buffer 2 Update Status Register", offset: "0x14",
		bits: [
			...
			{ name: "XMIN_SHDW2FULL", description: "XMINMAX_SHDW2 register full Status flag:", size: "1", shift: "14", mask: "0x4000" },
		]
	},
	{ name: "XREGSHDW3STS", description: "Shadow Buffer 3 Update Status Register", offset: "0x18",
		bits: [
			...
			{ name: "XMIN_SHDW3FULL", description: "XMINMAX_SHDW3 register full Status flag:", size: "1", shift: "14", mask: "0x4000" },
		]
	},
	...
	{ name: "DEACTCTL", description: "DE Action Control", offset: "0x4",
		bits: [
			...
			{ name: "TRIPENABLE", description: "Enables PWMTRIP condition to bypassDiode emulation", size: "1", shift: "16", mask: "0x10000" },
		]
	},
