let MEMCFGRegisters = [
	...
	{ name: "LSXMSEL", description: "Local Shared RAM Controller Sel Register", offset: "0x24",
		bits: [
	...
	{ name: "LSXACCPROT2", description: "Local Shared RAM Config Register 2", offset: "0x2C",
		bits: [
	...
	{ name: "GSXMSEL", description: "Global Shared RAM Controller Sel Register", offset: "0x44",
		bits: [
	...
	{ name: "MSGXCOMMIT", description: "Message RAM Config Lock Commit Register", offset: "0x62",
		bits: [
			{ name: "COMMIT_CPUTOCPU", description: "CPUTOCPU RAM control fields COMMIT", size: "1", shift: "0", mask: "0x1" },
	...
	{ name: "MSGXINIT", description: "Message RAM Init Register", offset: "0x72",
		bits: [
			...
			{ name: "INIT_CPUTOCLA1", description: "Initialization control for CPUTOCLA1 MSG", size: "1", shift: "1", mask: "0x2" },
			{ name: "INIT_CLA1TOCPU", description: "Initialization control for CLA1TOCPU MSG", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MSGXINITDONE", description: "Message RAM InitDone Status Register", offset: "0x74",
		bits: [
			{ name: "INITDONE_CPUTOCPU", description: "Initialization status for CPU to", size: "1", shift: "0", mask: "0x1" },
			{ name: "INITDONE_CPUTOCLA1", description: "Initialization status for CPU to", size: "1", shift: "1", mask: "0x2" },
			...
			{ name: "INITDONE_DMATOCLA1", description: "Initialization status for DMA to", size: "1", shift: "6", mask: "0x40" },
			{ name: "INITDONE_CPUTOCPU_MSGRAM1", description: "Initialization status for CPU to", size: "1", shift: "7", mask: "0x80" },
		]
	},
	{ name: "MSGXRAMTEST_LOCK", description: "Lock register for MSGx RAM TEST Register", offset: "0x76",
		bits: [
			{ name: "CPUTOCPU", description: "MSGxRAMTEST_LOCK.CPUTOCPULock", size: "1", shift: "0", mask: "0x1" },
			...
			{ name: "CPUTOCPU_MSGRAM1", description: "", size: "1", shift: "7", mask: "0x80" },
			{ name: "KEY", description: "KEY to enable write to lock", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	...
	{ name: "PERI_MEM_TEST_LOCK", description: "Peripheral Memory Test Lock Register", offset: "0xAA",
		bits: [
			...
			{ name: "KEY", description: "KEY to lock", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	...
	{ name: "EMIF1LOCK", description: "EMIF1 Config Lock Register", offset: "0x0",
		bits: [
			{ name: "LOCK_EMIF1", description: "EMIF1 access protection and controller fields lock", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "EMIF1COMMIT", description: "EMIF1 Config Lock Commit Register", offset: "0x2",
		bits: [
			{ name: "COMMIT_EMIF1", description: "EMIF1 access protection and controller select", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "EMIF1MSEL", description: "EMIF1 Controller Sel Register", offset: "0x4",
		bits: [
	...
	{ name: "NMAVINTEN", description: "Non-Controller Access Violation Interrupt Enable", offset: "0x6",
		bits: [
			{ name: "CPUREAD", description: "Non Controller CPU Read Access Violation Interrupt", size: "1", shift: "0", mask: "0x1" },
			...
			{ name: "DMAREAD", description: "Non Controller DMA Read Access Violation Interrupt", size: "1", shift: "10", mask: "0x400" },
		]
	},
