...
PAGE 0 :
   ...
   FLASH_BANK0_SEC1  : origin = 0x081000, length = 0x009000	/* on-chip Flash */
   // FLASH_BANK0_SEC2  : origin = 0x082000, length = 0x001000	/* on-chip Flash */
   // FLASH_BANK0_SEC3  : origin = 0x083000, length = 0x001000	/* on-chip Flash */
   // FLASH_BANK0_SEC4  : origin = 0x084000, length = 0x004000	/* on-chip Flash */
   ...
   /* BANK 1 */
   FLASH_BANK1_SEC0  : origin = 0x090000, length = 0x009000	/* on-chip Flash */
...
//   RAMM1_RSVD      : origin = 0x0007F8, length = 0x000008     /* Reserve and do not use for code as per the errata advisory "Memory: Prefetching Beyond Valid Memory" */
   ...
   RAMGS2      : origin = 0x010000, length = 0x003200
   RAMGS3      : origin = 0x013200, length = 0x000DF8
...
SECTIONS
{
   ...
   .rodata.tvm      : > FLASH_BANK1_SEC0
	.bss.noinit.tvm  : > RAMGS2
	FPUfftTables     : > RAMGS0
	FPUmathTables    : > RAMGS0
	FFT_buffer_1     : > RAMGS0, ALIGN = 512
