...
MEMORY
{
   ...
   RAMLS0           : origin = 0x00008000, length = 0x00004000
   // RAMLS1           : origin = 0x00008200, length = 0x00002300
   // RAMLS2           : origin = 0x00009000, length = 0x00000800
   // RAMLS3           : origin = 0x00009800, length = 0x00000800
   // RAMLS4           : origin = 0x0000A000, length = 0x00000800
   // RAMLS5           : origin = 0x0000A300, length = 0x00001A00
   // RAMLS6           : origin = 0x0000B000, length = 0x00000800
   // RAMLS7           : origin = 0x0000BB00, length = 0x00000500

   RAMGS0           : origin = 0x0000C000, length = 0x00003FF8
   // RAMGS1           : origin = 0x0000D000, length = 0x00001000
   // RAMGS2           : origin = 0x0000E000, length = 0x00001FF8
   ...
   FLASH_BANK0_SEC1  : origin = 0x081000, length = 0x009000
   ...
   /* BANK 1 */
   FLASH_BANK1_SEC0  : origin = 0x090000, length = 0x009000
  ...
  /* BANK 2 */
   ...
   FLASH_BANK2_SEC1  : origin = 0x0A1000, length = 0x002000
...
SECTIONS
{
   ...
   .esysmem         : > RAMLS0
   .cio             : > RAMLS0
   .econst          : > FLASH_BANK0_SEC1,  ALIGN(8)
#endif
   
   .rodata.tvm      : > FLASH_BANK1_SEC0
	.bss.noinit.tvm  : > RAMGS0
	FPUfftTables     : > RAMGS0
	FPUmathTables    : > RAMGS0
	FFT_buffer_1     : > RAMLS0, ALIGN = 512
