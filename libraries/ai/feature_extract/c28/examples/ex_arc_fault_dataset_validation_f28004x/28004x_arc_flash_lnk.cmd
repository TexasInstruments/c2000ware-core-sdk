...
PAGE 0 :
   ...
   FLASH_BANK0_SEC10 : origin = 0x08A000, length = 0x006000	/* on-chip Flash */
...
SECTIONS
{
   ...
   .bss:cio         : > RAMLS3,       PAGE = 0
   .data            : >> RAMLS5 | RAMLS6,       PAGE = 1
   .sysmem          : > RAMLS5,       PAGE = 1
   /* Initalized sections go in Flash */
   .const           : >> FLASH_BANK0_SEC5 | FLASH_BANK0_SEC6,       PAGE = 0,       ALIGN(4)
#else
   ...
   FFT_buffer_1     : > RAMGS0,    PAGE = 1, ALIGN(2048)
   FFT_buffer_2     : > RAMGS1,    PAGE = 1, ALIGN(2048)
   FPUfftTables     : > RAMGS3,    PAGE = 1
   FPUmathTables    : > RAMGS3,    PAGE = 1

   .rodata.tvm      : > FLASH_BANK0_SEC1,  PAGE = 0
   .bss.noinit.tvm  : > RAMGS2,       PAGE = 1
   .data.tvm        : > RAMGS2,       PAGE = 1
