...
extern const float tvmgen_default_bias_data[] __attribute__((weak)) = {-84.138054, -80.95066 , -79.657074};
extern const int32_t tvmgen_default_scale_data[] __attribute__((weak)) = {160, 201, 182};
