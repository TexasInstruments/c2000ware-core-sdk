 ...
 */
  ...
  extern const int32_t tvmgen_default_bias_data[] __attribute__((weak)) = {-89, -89, -84};
  extern const int32_t tvmgen_default_scale_data[] __attribute__((weak)) = {219, 225, 205};
  extern const int32_t tvmgen_default_shift_data[] __attribute__((weak)) = {7,7,7};
