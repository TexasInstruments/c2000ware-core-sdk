...
SECTIONS
{
   ...
   .stack           : > RAMM01
	...
	FFTipcb 		: >> RAMLS_BUFFERS, ALIGN(1024)
	FFTipcbsrc		: >> RAMLS_BUFFERS
	   ...
	   .bss:output      : > RAMLS
	   .init_array      : > RAMM01
	   .const           : >> RAMLS | RAMLS_BUFFERS | RAMM01
	   .data            : > RAMLS
	   .sysmem          : > RAMLS
	  .bss:cio          : > RAMLS
	#else
	   ...
	   .cio             : > RAMLS
	#endif
	FFTtf               : >> RAMLS | RAMLS_BUFFERS | RAMM01

#elif defined(_FLASH)
   .text            : >> FLASH_BANK0_SEC0_7,   ALIGN(8)
   .cinit           : > FLASH_BANK0_SEC0_7,  ALIGN(8)
   .switch          : > FLASH_BANK0_SEC0_7,  ALIGN(8)

	#if defined(__TI_EABI__)
	   .init_array      : > FLASH_BANK0_SEC0_7,  ALIGN(8)
	   .bss             : > RAMLS
	   .bss:output      : > RAMLS
	   .bss:cio         : > RAMLS
	   .data            : > RAMLS
	   .sysmem          : > RAMLS
	   .const           : > FLASH_BANK0_SEC0_7,  ALIGN(8)
	#else
	   .pinit           : > FLASH_BANK0_SEC0_7,  ALIGN(8)
	   .ebss            : > RAMLS
	   .esysmem         : > RAMLS
	   .cio             : > RAMLS
	   .econst          : > FLASH_BANK0_SEC0_7,  ALIGN(8)
	#endif

   .TI.ramfunc      : LOAD = FLASH_BANK0_SEC0_7,
                      RUN = RAMLS,
