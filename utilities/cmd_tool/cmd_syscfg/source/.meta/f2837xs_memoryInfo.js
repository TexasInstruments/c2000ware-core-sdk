...
// RAMGS12-15 not present in 376S/374S
// Flash Bank1 not present in 376S/374S
...
var memoryInfo = {
    ...
    memoryRanges : [
        ...
        {name : "FLASHN", group : "FLASH", origin : 0x0BE000, length : 0x002000, description : "Flash Bank 0"},
        {name : "FLASHO", group : "FLASH", origin : 0x0C0000, length : 0x002000, description : "Flash Bank 1"},
        {name : "FLASHP", group : "FLASH", origin : 0x0C2000, length : 0x002000, description : "Flash Bank 1"},
        {name : "FLASHQ", group : "FLASH", origin : 0x0C4000, length : 0x002000, description : "Flash Bank 1"},
        {name : "FLASHR", group : "FLASH", origin : 0x0C6000, length : 0x002000, description : "Flash Bank 1"},
        {name : "FLASHS", group : "FLASH", origin : 0x0C8000, length : 0x008000, description : "Flash Bank 1"},
        {name : "FLASHT", group : "FLASH", origin : 0x0D0000, length : 0x008000, description : "Flash Bank 1"},
        {name : "FLASHU", group : "FLASH", origin : 0x0D8000, length : 0x008000, description : "Flash Bank 1"},
        {name : "FLASHV", group : "FLASH", origin : 0x0E0000, length : 0x008000, description : "Flash Bank 1"},
        {name : "FLASHW", group : "FLASH", origin : 0x0E8000, length : 0x008000, description : "Flash Bank 1"},
        {name : "FLASHX", group : "FLASH", origin : 0x0F0000, length : 0x008000, description : "Flash Bank 1"},
        {name : "FLASHY", group : "FLASH", origin : 0x0F8000, length : 0x002000, description : "Flash Bank 1"},
        {name : "FLASHZ", group : "FLASH", origin : 0x0FA000, length : 0x002000, description : "Flash Bank 1"},
        {name : "FLASHAA", group : "FLASH", origin : 0x0FC000, length : 0x002000, description : "Flash Bank 1"},
        {name : "FLASHBB", group : "FLASH", origin : 0x0FE000, length : 0x001FF0, description : "Flash Bank 1. Last 16 words of Flash is reserved as per the errata advisory 'Memory: Prefetching Beyond Valid Memory'"},
