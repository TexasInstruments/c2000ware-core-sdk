...
var memoryInfo = {
    ...
    memoryRanges : [
        ...
        {name : "BEGIN", origin : 0x080000, length : 0x000002},
        ...
        {name : "FLASH_BANK0",  group : "FLASH", origin : 0x080002, length : 0x1FFFE}, // slightly different address for flash and ram linker.cmd files
