...
{
    if (["F2838x", "F28003x", "F280013x", "F280015x", "F28P65x", "F28P55x", "F28P551x", "F28E12x"].includes(getDeviceName()))
    {
        return {
...
function getZone2Password1Mask(zsb_index){
    ...
    else if (["F2838x", "F28003x", "F280013x", "F280015x","F28P65x", "F28P55x", "F28P551x", "F28E12x"].includes(getDeviceName()))
    {
        DEFAULT_ZONE2_PASSWORD_MASK =
        [
