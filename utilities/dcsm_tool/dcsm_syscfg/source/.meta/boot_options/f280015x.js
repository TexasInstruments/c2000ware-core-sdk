let f280015x_boot =[
    {name: "0x00", displayName:"(PARALLEL) D0-D7=GPIO(0,1,3,5,7,24,28,29) , MCU-Control=GPIO224 , Host-Control=GPIO242"},
    {name: "0x20", displayName:"(PARALLEL) D0-D7=GPIO(0,1,2,3,5,6,7,24) , MCU-Control=GPIO12 , Host-Control=GPIO13"},
    {name: "0x40", displayName:"(PARALLEL) D0-D7=GPIO(0,1,2,3,5,6,7,24) , MCU-Control=GPIO16 , Host-Control=GPIO29"},
    ...
    {name: "0x02", displayName:"(CAN) CANTXA=GPIO7 , CANRXA=GPIO5"},
    ...
    {name: "0x08", displayName:"(CAN-FD) CANTXA=GPIO1 , CANRXA=GPIO0"},
    {name: "0x28", displayName:"(CAN-FD) CANTXA=GPIO4 , CANRXA=GPIO5"},
