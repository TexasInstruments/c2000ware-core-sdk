...
let config = [
    ...
    },
    {
        ...
        getValue: (inst) => {
            let size = 0;
            for (let logVar of inst["dltlogVariables"]) {
                size += logVar.size;
            }
            return size;
        }
...
function moduleInstances(inst)
{
    ...
    ownedInstances.push({
        name: "dltlogVariables",
        displayName: "DLT Log Variables",
        moduleName: transferCommon.getTransferPath() + "logger/dltvariable.js",
        useArray: true,
