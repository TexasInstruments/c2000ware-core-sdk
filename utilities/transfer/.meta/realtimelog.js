...
var rtlogModule = {
    displayName: "Real-Time Logger (BETA)",
    maxInstances: 1,
    defaultInstanceName: "myRTLOG",
    description: "Real-time Log Module",
    config          : config,
    moduleInstances : moduleInstances,	
    modules: modules,
    templates: {
		[transferCommon.getTransferPath() + "logger/realtime_log.json.xdt"] : "",
		[transferCommon.getTransferPath() + "logger/realtime_log.c.xdt"] : "",
		[transferCommon.getTransferPath() + "logger/realtime_log.h.xdt"] : "",
	},
    validate: onValidate
};
