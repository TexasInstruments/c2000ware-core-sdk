...
/* Intro splash on GUI */
let longDescription = "The Rapid-Time Logger module provides a software layer for a highly optimized data logging implementation using bit-packing in the FSI peripheral and customized message structures. " +
"Application variables and arrays are added as Log Variables in Log Message Structure Definitions which are stored in the autogenerated rt_log.json lookup table. " +
"This module can be used in conjunction with the MCU Control Center module in a different Sysconfig project. In the secondary (bridge) project, the Rapid-Time Logger option setting inside MCU Control Center module is used and the rt_log.json file is uploaded.";
...
var rtlogModule = {
    ...
    description: "Rapid-Time Logger Module",
    config          : config,
